...
#include <tuw_uvc/CameraWideAngleConfig.h>

class V4RWideAngleNode : public V4RCamNode {
public:
    V4RWideAngleNode ( ros::NodeHandle &n ):V4RCamNode(n) {
        reconfigureFnc_ = boost::bind(&V4RWideAngleNode::callbackParameters, this,  _1, _2);
