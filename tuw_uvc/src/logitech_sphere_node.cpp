...
class V4RLogitechSphereNode : public V4RCamNode {
public:
    V4RLogitechSphereNode ( ros::NodeHandle &n ):V4RCamNode(n) {
        reconfigureFnc_ = boost::bind(&V4RLogitechSphereNode::callbackParameters, this,  _1, _2);
